...
const STYLE_BY_TITLE: Record<string, { seniority: string; style: string }> = {
  "Engineering Manager": { seniority: "8-12 yrs eng", style: "Calm, structured. Probes for ownership and tradeoffs." },
  "Senior IC Peer": { seniority: "Senior IC", style: "Curious, technical, wants real war stories." },
  "Skip-level VP Eng": { seniority: "VP", style: "Strategic. Tests for clarity of thinking under abstraction." },
  CTO: { seniority: "Executive", style: "Sharp, busy. No fluff. Wants signal fast." },
  "Tech Lead": { seniority: "Staff IC", style: "Pragmatic. Probes architecture and team dynamics." },
  "Sales Hiring Manager": { seniority: "Director", style: "Direct, results-oriented. Tests deal mechanics." },
  "Senior AE Peer": { seniority: "Senior AE", style: "Conversational, swaps stories, pressure-tests pipeline." },
  ...
  "Engineering Counterpart": { seniority: "Senior", style: "Wants to know if you'll respect engineering." },
  "Designer Counterpart": { seniority: "Senior", style: "Wants to feel craft and taste in your thinking." },
  ...
  "Senior IC Designer": { seniority: "Senior", style: "Wants to peel back the why behind every decision." },
  ...
  "Chief of Staff": { seniority: "Executive Adjacent", style: "Tests organization, judgment, written clarity." },
  Investor: { seniority: "Partner", style: "Scrutinizes thesis, market, conviction." },
  "Hiring Manager": { seniority: "Director", style: "Friendly but evaluative. Tests fit and capability." },
  "Skip-Level Leader": { seniority: "VP", style: "Higher-altitude. Probes judgment and ambition." },
  "Cross-functional Peer": { seniority: "Senior", style: "Will you make their job easier or harder?" },
  Recruiter: { seniority: "Senior recruiter", style: "Warm, structured, screens for fit and motivation." },
};
